...
full_dat <- readRDS("./Analysis/Analysis_Detection_Probability/Data/2023_PAMData_FormatforOccModSCALED.Rdata")
...
fit_5 <- jags(data = jags_data, 
                 model.file = "./Analysis/Analysis_Detection_Probability/Model_Structure_Files/JAGS_ARUMod5.txt",
...
saveRDS(fit_5, "./Analysis/Analysis_Detection_Probability/Models_Ran_Outputs/MetChap_ARUMod5.Rdata")
```

### Model outputs: 
```{R, eval = FALSE, echo = FALSE}
fit_5 <- readRDS("./Analysis/Analysis_Detection_Probability/Models_Ran_Outputs/MetChap_ARUMod5.Rdata")
```
```{R}
summary(fit_5)
```
